...
export const mintArgsBuilder = (candyMachine, guardToUse, ownedTokens) => {
...
export const routeBuilder = async (umi, guardToUse, candyMachine) => {
...
export const combineTransactions = (umi, txs, tables) => {
  const returnArray = [];
